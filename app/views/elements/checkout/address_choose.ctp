...
<div id="choose-<?php echo $type; ?>"<?php echo (!empty($hidden)) ? ' style="display: none;"' : ''; ?>>
	<?php $i = 0; ?>
	<?php foreach ($addresses as $k => $address): ?>
		...
		?>
		<div class="address-choice" style="clear: <?php echo ($i % 4 == 0) ? 'left' : 'none'; ?>">
			
			<?php if ($type == 'shipping'): ?>
				<?php echo h($a['first_name']); ?> <?php echo h($a['last_name']); ?><br />
			<?php endif; ?>
