...
class PaypalHelper extends AppHelper {
  ...
  /**
    ...
    *      etc...
    */
  function button($title = null, $options = array(), $buttonOptions = array()){
    if(is_array($title)){
      $options = $title;
    ...
    $retval .= $this->__submitButton($title, $buttonOptions);
   ...
   * @return Html form button and close form
   */
  function __submitButton($text, $buttonOptions){
    return "</div>" . $this->Form->button($text, $buttonOptions) . $this->Form->end();
  }
